...
import solution
from Singleview_Geometry import Camera_Model, Camera_Decomposition, Affine_Camera
...
if __name__ == "__main__":
    ...
    affine_model = Affine_Camera(focal_len, center_offset, rotate_angle, camera_center)
    ...
    # camera_model = Camera_Decomposition(camera_mat)
    pass
